...
| [XXXX](XXXX-archive-url-browse-and-streaming-hud.md) | The `?archive=` browse entry point, the streaming HUD (`window.__reticle_stats`), main-thread OPFS fallback, and the served-archive e2e (placeholder number, assigned at merge) |
