...
| [0068](0068-archive-serving-worker-and-license-gate.md) | The archive-serving Worker (R2 range proxy, Cache API, CORS lock, untrusted-Range 416) and the redistribution license gate |
