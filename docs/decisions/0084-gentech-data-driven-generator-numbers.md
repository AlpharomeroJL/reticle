# 0084, GenTech: the generator process numbers become data, threaded through the tech argument
...
the both-PDK cleanliness oracle (ADR 0085). The residue and the authored constant carry
