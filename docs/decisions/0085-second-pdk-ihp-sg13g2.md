# 0085, A second PDK (IHP SG13G2) as data, proven by the both-PDK cleanliness proptests

## Context

ADR 0084 made the generator process numbers data (`GenTech`). The point of that work is
...
enclosure, ADR 0084). No topology, schema, or validation code is PDK-specific. The
