# 0068, A deterministic static leaderboard with the record format as its API
...
silently mis-rendering. No frozen surface changed: the leaderboard and validator are
