...
WAVE 5: merge done-parked 5A/5C/5D/5E at the gate (MERGE 5A FIRST - 5B needs LefDefDesign frozen at 5A merge) + dispatch 5B after 5A merged; 5B container oracles use pinned E: images. Verify each done-parked lane at its gate (RESULT.md may be absent - verify vs success bar + log). ADR numbering continues 0082+.
