...
THEN: merge 1E (v8-1e-proof; renumber ADR placeholder 0068->0082; resolve README/docs-README/justfile/e2e-playwright.config.ts/collaboration.md conflicts; 4C did NOT touch app.rs so 1E's app.rs seam only conflicts w/ 4A+4B regions). Then WAVE 5: merge done-parked 5A/5C/5D/5E at the gate (5A LefDefDesign frozen at merge) + dispatch 5B after 5A merged; container oracles pinned E: images.
