...
IN FLIGHT (Wave 3 batch 1, running): v8-3a-drc-live (DRC-as-you-type, CPU, reticle-app+drc; UUID fec33034-f2b3-4ff6-92d0-296416de0d8d), v8-3b-gpu-heatmap (GPU DRC heatmap, GPU lane, reticle-render; UUID 7c201b7d-82a6-451e-b1b8-3071b078eaa8). Done-parked awaiting their WAVE gates (merge at Wave 5/6/7): 5A/5C/5D/5E (Wave 5), 6A (Wave 6), 7A (Wave 7), 1E (Wave 1 tail - can merge anytime, low priority).
