...
4A STILL IN FLIGHT: v8-4a-diff (UUID f2e69d57-7946-4cb6-8407-d76849c3d653; new reticle-diff crate + app diff overlay). Log scratch/logs/v8-4a-diff.stream.jsonl. (DISPATCH GOTCHA: from the Bash tool, backslash -File paths mangle to exit-127; use FORWARD-SLASH: powershell.exe -File D:/dev/reticle/scratch/dispatch-lane.ps1 -Id <id> -SessionId <uuid>.)
...
DONE-PARKED awaiting their WAVE gates: 5A/5C/5D/5E (Wave 5), 6A (Wave 6), 7A (Wave 7), 1E (Wave 1 tail, merge anytime low-pri). Later waves: W5 merge 5A/5C/5D/5E + dispatch 5B (after 5A LefDefDesign frozen); W6 merge 6A + dispatch 6B(vision, never w/GPU)/6C; W7 merge 7A + freeze leaderboard + 7B/7C(bench STOPPED); W8 product page + soak; W9 gauntlet+audit+tag v8.0.0+release. Bench banked 81/83 (72 pass).
